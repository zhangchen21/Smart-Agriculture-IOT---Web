...
import { IllnesspredictionArea } from './pages/illness/components/predictionArea/index'
    ...
    <Router>
      <Routes >
        ...
        <Route path="/illness" element={ <Illness/> }>
          <Route path="" element={<IllnesspredictionArea />}></Route>
          <Route path="illnessresultHistory" element={<IllnessresultHistory />}></Route>
          <Route path="illnesspredictionArea" element={<IllnesspredictionArea />}></Route>
        </Route>
